...
var DBManager = DBManager || React.createClass({
    ...
    render: function () {
        ...
        var form = React.DOM.span(null, null);
        if (this.state.status) {
            ...
            case DB.statuses.CLOSED:
                contents = [
                    ...
                    React.DOM.input(
                        {type: 'submit', value: 'Open Database'},
                        null
                    )
                ];
                break;
            case DB.statuses.OPEN:
                contents = React.DOM.input(
                    {type: 'submit', value: 'Close Database'},
                    null
                );
                break;
            case DB.statuses.EMPTY:
            ...
            form = React.DOM.form(
                {onSubmit: this.submitHandler, ref: 'form'},
                contents
            );
        }
